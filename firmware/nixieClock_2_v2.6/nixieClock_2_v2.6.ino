...
#define DUTY 170        // скважность ШИМ. От скважности зависит напряжение! у меня 175 вольт при значении 180 и 145 вольт при 120

#define BEEPER_TYPE 0
// Тип динамика: 
// 0 - стандартный, питается переменкой с частотой звука
// 1 - автономный, со встроенным генератором, питается постоянкой
...
// ======================  МИГАНИЕ =======================
#define DOT_TICK_STYLE 1	 // 0 - оригинальная реализация Алекса: быстрая вспышка и пауза в DOT_TIME мс
                        	 // 1 - традиционный стиль: и вспышка, и пауза длятся DOT_TIME мс
